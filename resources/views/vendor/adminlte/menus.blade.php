...
<section class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card card-secondarycollapsed-card">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card card-secondaryshadow-none">
            <div class="card-header">
      ...
      <div class="row">
        <div class="col-md-3">
          <!-- DIRECT CHAT PRIMARY -->
          <div class="card card-secondarycard-outline direct-chat direct-chat-primary">
            <div class="card-header">
      ...
      <div class="row">
        <div class="col-md-3">
          <!-- DIRECT CHAT PRIMARY -->
          <div class="card card-secondarycard-outline direct-chat direct-chat-secondaryshadow-none">
            <div class="card-header">
              <h3 class="card-title">Shadow - None</h3>
            ...
            <div class="col-md-12 col-lg-6 col-xl-4">
              <div class="card mb-2 bg-gradient-dark">
                ...
                <div class="card-img-overlay d-flex flex-column justify-content-end">
                  <h5 class="card-title text-secondarytext-white">Card Title</h5>

{{ Form::open(['method' => 'POST','route' => ['slider.store'],'class' => 'form-horizontal inline','enctype' => 'multipart/form-data']) }}
    <div class="card-body"> 
        ...
        <div class="form-group">
            ...
            {{ Form::textarea('text', old('text'), ['class' => 'form-control', 'id' => 'text', 'placeholder' => 'Text', 'rows'=> 5, 'required']) }}             
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="help-block">Ukuran Gambar Harus pas</div>
        </div>
    </div>

...
@section('content')
    {{ Form::open(['method' => 'POST', 'route' => ['post.store'], 'class' => 'form-horizontal inline', 'enctype' => 'multipart/form-data']) }}
    <div class="card" style="margin-top: 10px;">
        <div class="card-header">
            ...
            <div style="float: right">
                ...
                {!! kembali(['url' => '/management/post', 'style' => 'float:right;margin-right: 5px;', 'title' => 'Batal']) !!}
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        {{ Form::text('title', old('title'), ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Judul', 'required']) }}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('meta', old('meta'), ['class' => 'form-control', 'id' => 'meta', 'placeholder' => 'Meta Blog']) }}
                    </div>
                    <div class="form-group">

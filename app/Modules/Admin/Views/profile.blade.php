...
<br>
  <div class="card card-widget widget-asset col-md-4" style="margin: auto;padding-top: 7.5px;">
      ...
      <div class="widget-asset-header bg-info">
          <h3 class="widget-asset-assetname">{{ $admin->name }}</h3>
          <h5 class="widget-asset-desc">Founder &amp; CEO</h5>
      </div>
      <div class="widget-asset-image">
          <img src="{{ $admin->photo ? $admin->photo : asset('assets/images/company.png') }}"
              class="profile-asset-img img-fluid img-circle img-responsive image-logo" data-title="{{ $admin->name }}"

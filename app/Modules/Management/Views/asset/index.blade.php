                ...
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-asset_category-tab" data-toggle="pill"
                            href="#custom-tabs-one-asset_category" role="tab"
                            aria-controls="custom-tabs-one-asset_category" aria-selected="true">Kategori Asset</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-asset_status-tab" data-toggle="pill"
                            href="#custom-tabs-one-asset_status" role="tab"
                            aria-controls="custom-tabs-one-asset_status" aria-selected="true">Status Asset</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">

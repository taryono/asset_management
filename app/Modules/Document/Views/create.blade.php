...
@section('content')
{{ Form::open(array('route' => $controller_name.'.store')) }} 
                ...
                <div class="panel-body">
                    <table class="table-form"> 
                        <tr class="css">
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::textarea('css', null, array('class'=>'form-control', 'cols'=> "100")) }}
                        ...
                        <tr class="content">
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::textarea('header', null, array('class'=>'form-control text-editor')) }}
                        ...
                        <tr class="content">
                            ...
                            <td>:</td>
                            <td>
                                {{ Form::textarea('footer', null, array('class'=>'text-editor', 'rows'=> '1000')) }}

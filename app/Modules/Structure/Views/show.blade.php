    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                {!! create([
                    'url' => route('staff.create', $structure->id),
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="staff" class="table table-bordered table-hover display standard" style="width: 100%"
                    data-route="{{ route('structure.getListAjaxEmployees', $structure->id) }}">
                    <thead>
                        <tr>
